...
```
deno run --allow-run='gh,git' --unstable https://deno.land/x/denotation@v0.4.4/cli.ts -- --help
```

```
deno install --allow-run='gh,git' --unstable -n denote https://deno.land/x/denotation@v0.4.4/cli.ts
denote --help
```
  ...
  release:
    ...
    steps:
      ...
      - uses: denoland/setup-deno@v1.1.0
        with:
          deno-version: v1.x.x
      - run: deno run --allow-run='gh,git' --unstable https://deno.land/x/denotation@v0.4.4/cli.ts
        env:
